...
import { ScrollData, Scroller, useScroll } from "./scroller";
import { Button, chipColorKeys, chipTextColors, Countdown, Divider, Input, Loading, Modal, px, Text,
	ThemeSpinner, useAsync, useDisposable, useGoto, useShortcuts, useTimeUntil } from "./ui";
	...
	return <>
		...
		{home == true && (untilStart != null && untilStart < 0
			? (<div className="flex flex-col gap-2 items-stretch">
				...
				{untilEnd != null && untilEnd < 0
					&& <Button onClick={() => goto("/submissions")}>View submissions</Button>}
			</div>)
			: <div />)}
	</>;
}
